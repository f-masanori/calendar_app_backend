...
type AllInOneHandler struct {
	Service *services.AllInOneService
}

func NewAllInOneHandler(sqlHandler *database.SqlHandler) *AllInOneHandler {
	return &AllInOneHandler{
		Service: &services.AllInOneService{
			AllInOneRepository: &sqlcmd.AllInOneRepository{
...
func (e *AllInOneHandler) AddScript(w http.ResponseWriter, r *http.Request) {
